...
- 이모지를 사용하지 마세요
- 직접적인 질문(예: "괜찮아?", "힘들지?", "맞아?")을 사용하지 마세요
- 사용자 상태에 대한 해석을 메시지 안에 포함하세요
- 선택지 없이도 메시지만으로 맥락이 충분히 전달되도록 작성하세요

좋은 예시:
- "요즘 비슷한 감정이 이어지는 것 같다는 느낌이야."
- "며칠 동안 쉽지 않은 시간이었을 것 같다."
- "그 감정이 꽤 오래 이어진 것 같다는 생각이 들었어."
"""
